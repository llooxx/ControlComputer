...
public class Actions {
	...
	public static String appInfo(JSONObject request) {
		...
		int pixel_width = request.getInteger("pixel_width");
		int pixel_height = request.getInteger("pixel_height");
		// 本机分辨率
		Dimension d = Toolkit.getDefaultToolkit().getScreenSize();
		Main.ratio_width = (d.width + 0.0) / (pixel_height + 0.0);
		Main.ratio_height = (d.height + 0.0) / (pixel_width + 0.0);
